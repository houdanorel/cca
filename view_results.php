        ...
        else
        {
            if( strlen (rtrim ($lines)) > 0)
            {
                ...
                {  
                    ...
                    else if(substr_count(ucwords(strtolower($str)), "Event") == 1)
                    {
                        $st.= "<thead>";
                        $st.= "<tr> ";
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            // $st.= "<td >".$CCA."</td> ";
                            $st.= "<td >".$PL."</td>";
                            $st.= "<td ><a class='simple-ajax-popup' href='dialog.php?id=$CCA&profiles=$xml_profiles&pics=$pictures_path'>".$Member_name."</a></td> "; 
                            $st.= "<td >".$Stock."</td> ";
                            $st.= "<td >".$Mark_Time."</td> ";
                            $st.= "<td >".$Money_WON."</td> "; 
                            $st.= "<td >".$GND_Money."</td> "; 
...
function Submit(id,loc,dates,gr) { 
    ...
    $('#myform').attr('action','view_results.php');
